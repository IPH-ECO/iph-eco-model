    ...
    Subroutine WriteOutputs(simParam,HydroParam,MeshParam,LimnoParam,MeteoParam)
    ...
    Integer:: i,c,icell,iElem,iLayer,face
    Real:: V,eair
    ...
    If (simParam%outputTimeStep /= 0) Then
        ...
        If (mod(simParam%it,simParam%outputTimeStep)==0.or.simParam%it==1) Then
            ...
            !    !Gravando u
            !    icell = 1
            !    Do iLayer=1,12 !HydroParam%ElSmallm(icell),HydroParam%ElCapitalM(icell)
            !        If (iLayer==HydroParam%ElCapitalM(icell)) Then
