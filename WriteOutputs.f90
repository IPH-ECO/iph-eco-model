    ...
    If (simParam%outputTimeStep /= 0) Then
        ...
        If (mod(simParam%it,simParam%outputTimeStep)==0.or.simParam%it==1) Then
            ...
            !
                ...
                Write(96,'(I10,A10,100F30.20)') simParam%it,'Sup', HydroParam%Vol(icell-1),HydroParam%Vol(icell), HydroParam%Vol(up-1), HydroParam%Vol(up),  HydroParam%Vol(upup-1), HydroParam%Vol(upup), HydroParam%u(iLayer,face), HydroParam%H(face), simParam%dt, HydroParam%eta(icell),HydroParam%eta(up-1), HydroParam%eta(up),HydroParam%eta(upup-1),HydroParam%eta(upup)
