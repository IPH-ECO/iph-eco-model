...
!                            !dtbCFL = Max(HydroParam%CFL(l)/dt,HydroParam%CFL(r)/dt)
!                            !ndels = Max(Floor(dt/dtb),HydroParam%NFUT,dtbCFL)
...
!        dtin = dtb
!        Call quicksearch(1,nnel,jlev,dtb,dtin,x0,y0,z0,xt,yt,zt,iflqs1,idt,id0,i34,uuint,vvint,wwint,BoundConditionFlag,IntersectFlag,nel_j,HydroParam,MeshParam)   
!        dtb = dtin
!        
!        if(isnan(dtb)) Then
!            continue
...
!    &xt,yt,zt,nfl,idt,id0,i34,uuint,vvint,wwint,BoundConditionFlag,IntersectFlag,nel_j,HydroParam,MeshParam)
!
...
!    Integer:: BoundConditionFlag,IntersectFlag
