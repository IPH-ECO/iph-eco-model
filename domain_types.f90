module domain_types
    ...
    type, bind(C) :: hydroOutputParameter
        character(kind = c_char, len = 255) :: name
    end type

    type, bind(C) :: wqOutputParameter
        character(kind = c_char, len = 255) :: name
    end type
    
    type, bind(C) :: wqoOutputParameter
        character(kind = c_char, len = 255) :: name
    end type
    ...
    type, bind(C) :: Simulation
        ...
        integer(c_int) :: wqoOutputParametersLength
        type(c_ptr) :: wqoOutputParameters
